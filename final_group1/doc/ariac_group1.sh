...
terminator -T "Ariac Gazebo" -e "zsh -c 'source /opt/ros/galactic/setup.zsh; source $ws_path/install/setup.zsh; clear; ros2 launch ariac_gazebo ariac.launch.py competitor_pkg:=final_group1 sensor_config:=sensors trial_name:=final_spring2024'" &
